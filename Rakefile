...
task :submodule do
  sh 'git submodule update --init' unless File.exist?('novacancy.js/README.md')
end
...
task javascripts: :submodule do
  ...
  FileUtils.cp_r Dir['novacancy.js/javascript/*'], target_dir
end
...
task stylesheets: :submodule do
  ...
  FileUtils.cp Dir['novacancy.js/css/*'], target_dir
end
